...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center py-4 lg:py-0 ${sticky
        ...
        <div className="flex items-center justify-between w-screen px-6 ">
          ...
          <div>
            <button
              ...
              className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg px-4 py-[6px] ring-primary lg:hidden"
            >
              <span
