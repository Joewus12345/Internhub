    ...
    <div className="flex justify-center items-center flex-col">
      <div className="w-full h-14 bg-purple-500 sticky top-0 flex gap-4 items-center text-white px-12 cursor-pointer">
        ...
        <a
          ...
          className="transition-colors hover:text-foreground text-inherit flex items-center text-white cursor-pointer"
        >
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/logo.svg" alt="logo" /> Internhub
        </a>
        <Link href={"/student/dashboard/applications"} className="text-sm transition-colors hover:text-foreground text-inherit cursor-pointer">
          Applications
        </Link>
      </div>
