  ...
  return (
    <>
      <div className="min-h-screen w-full flex flex-col lg:grid lg:grid-cols-2 relative">
              ...
              >
                ...
                >
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input  {...register("phone")} placeholder="country code and phone number" />
                    {errors.phone && (
                      <p className="text-red-600 text-xs">
                        {" "}
        ...
        <Link href="/" className="absolute flex items-center gap-1 top-4 left-6 font-bold  text-purple-600">
