        ...
        <div className="flex-1 flex items-center justify-center sm:py-12 py-16">
          <div className="mx-auto grid w-[320px] xs:w-[350px] gap-6 p-6 rounded-xl bg-white/30 backdrop-blur-md lg:bg-transparent lg:backdrop-blur-none lg:p-0 lg:rounded-none">
            ...
            {state === 0 && (
              ...
              >
                <div className="grid gap-1 mb-2">
                  ...
                  <Input id="refNum" type="text" {...register("companyName")} placeholder="company name" />
                  {errors.companyName && (
                ...
                <div className="grid gap-2 mt-2 mb-2 ">
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                      <Select value={value} onValueChange={onChange}>
                        <SelectTrigger className="w-full">
                          <SelectValue placeholder="Are you the hiring manager" />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectGroup>
            ...
            <div className="mt-4 text-center text-sm">
              ...
              <Link href="/recruit/" className="underline">
                Login
              </Link>
            </div>
          </div>
